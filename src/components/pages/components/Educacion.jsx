        ...
        <div className="container">
          ...
          <div class="row">
            <div class="col-4">
              ...
              <a class="list-group-item list-group-item-action" id="list-settings-list" data-bs-toggle="list" href="#list-settings" role="tab" aria-controls="list-settings">Estudios Realizados</a>
